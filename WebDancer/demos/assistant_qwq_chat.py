...
def init_dev_search_agent_service(model: str="WebDancer-QwQ-32B", base_url: str = "http://127.0.0.1:8004/v1", api_key:str='EMPTY',desc: str = '初版', reasoning: bool = True, max_llm_calls: int = 20, tools = ['search', 'visit', 'knowledgeBase'], addtional_agent = None):
